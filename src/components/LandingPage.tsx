          ...
          <div className="flex flex-col items-center justify-center text-center">
            ...
            >
              ...
              <p className="text-lg md:text-xl text-slate-600 dark:text-slate-400 mb-10 leading-relaxed max-w-2xl mx-auto font-light">
                Ask complex questions in plain English. Get structured summaries sourced strictly from <strong>National Clinical Guidelines</strong>.
              </p>
              ...
              <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mb-12">
                ...
                <button 
                  ...
                  className="w-full sm:w-auto px-8 py-4 bg-white dark:bg-white/5 border border-slate-200 dark:border-white/10 text-slate-700 dark:text-slate-200 font-bold rounded-xl hover:bg-slate-50 dark:hover:bg-white/10 transition-colors backdrop-blur-sm"
                >
                  See how it works
                </button>
              </div>
              ...
              {/* Trust Bullets */}
              <div className="flex flex-wrap justify-center gap-x-8 gap-y-3 text-sm font-medium text-slate-500 dark:text-slate-500">
                ...
                <div className="flex items-center gap-2">
                   ...
                   <span>National Clinical Guidelines</span>
                </div>
                <div className="flex items-center gap-2">
