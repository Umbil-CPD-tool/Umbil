...
export type ToolId = 'referral' | 'safety_netting' | 'digital_triage' | 'discharge_summary' | 'sbar' | 'patient_friendly';
...
const Icons = {
  ...
  Triage: <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M21 15a2 2 0 0 1-2 2H7l-4 4V5a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2z"/><path d="M8 10h.01"/><path d="M12 10h.01"/><path d="M16 10h.01"/></svg>,
...
export const TOOLS_CONFIG: ToolConfig[] = [
  ...
  { 
    ...
    icon: Icons.Triage, 
    placeholder: "Paste the patient's AccuRx / online message, e.g. \"I've had a headache for a few days and it's not going away\"", 
